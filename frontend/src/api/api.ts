 ...
 * 
 * @export
 * @interface GetPopularPostsSuccessDto
 */
export interface GetPopularPostsSuccessDto {
    /**
     * 
     * @type {Array<PostDto>}
     * @memberof GetPopularPostsSuccessDto
     */
    posts: Array<PostDto>;
    /**
     * 
 ...
 * 
 * @export
 * @interface GetPostsSuccessDto
 */
export interface GetPostsSuccessDto {
    /**
     * 
     * @type {Array<PostDto>}
     * @memberof GetPostsSuccessDto
     */
    posts: Array<PostDto>;
}
/**
...
export const DevApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        devControllerUpdateAllPostScores(options: any = {}): FetchArgs {
            const localVarPath = `/api/dev/update-scores`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const DevApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        devControllerUpdateAllPostScores(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
            const localVarFetchArgs = DevApiFetchParamCreator(configuration).devControllerUpdateAllPostScores(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const DevApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        devControllerUpdateAllPostScores(options?: any) {
            return DevApiFp(configuration).devControllerUpdateAllPostScores(options)(fetch, basePath);
        },
    };
};
...
export class DevApi extends BaseAPI {
     ...
     * @memberof DevApi
     */
    public devControllerUpdateAllPostScores(options?: any) {
        return DevApiFp(this.configuration).devControllerUpdateAllPostScores(options)(this.fetch, this.basePath);
    }
...
export const PostsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postsControllerGetPostsByUserID(userID: string, options: any = {}): FetchArgs {
            // verify required parameter 'userID' is not null or undefined
            if (userID === null || userID === undefined) {
                throw new RequiredError('userID','Required parameter userID was null or undefined when calling postsControllerGetPostsByUserID.');
            }
            const localVarPath = `/api/posts/byUser/{userID}`
...
export const PostsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postsControllerGetPostsByUserID(userID: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetPostsSuccessDto> {
            const localVarFetchArgs = PostsApiFetchParamCreator(configuration).postsControllerGetPostsByUserID(userID, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const PostsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        postsControllerGetPostsByUserID(userID: string, options?: any) {
            return PostsApiFp(configuration).postsControllerGetPostsByUserID(userID, options)(fetch, basePath);
        },
        /**
         * 
         * @param {string} postID 
...
export class PostsApi extends BaseAPI {
     ...
     * @memberof PostsApi
     */
    public postsControllerGetPostsByUserID(userID: string, options?: any) {
        return PostsApiFp(this.configuration).postsControllerGetPostsByUserID(userID, options)(this.fetch, this.basePath);
    }
...
export const TrendingApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        trendingControllerGetPopularPosts(options: any = {}): FetchArgs {
            const localVarPath = `/api/trending/popularPosts`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const TrendingApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        trendingControllerGetPopularPosts(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetPopularPostsSuccessDto> {
            const localVarFetchArgs = TrendingApiFetchParamCreator(configuration).trendingControllerGetPopularPosts(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const TrendingApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        trendingControllerGetPopularPosts(options?: any) {
            return TrendingApiFp(configuration).trendingControllerGetPopularPosts(options)(fetch, basePath);
        },
        /**
         * 
         * @param {number} fetchCount 
...
export class TrendingApi extends BaseAPI {
     ...
     */
    public trendingControllerGetPopularPosts(options?: any) {
        return TrendingApiFp(this.configuration).trendingControllerGetPopularPosts(options)(this.fetch, this.basePath);
    }
...
export const UserApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        userControllerGetFollowingFollowersOfUser(options: any = {}): FetchArgs {
            const localVarPath = `/api/user/followingFollowers`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const UserApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        userControllerGetFollowingFollowersOfUser(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetUsersSuccessDto> {
            const localVarFetchArgs = UserApiFetchParamCreator(configuration).userControllerGetFollowingFollowersOfUser(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const UserApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        userControllerGetFollowingFollowersOfUser(options?: any) {
            return UserApiFp(configuration).userControllerGetFollowingFollowersOfUser(options)(fetch, basePath);
        },
        /**
         * Retrieve the current logged in user
         * @param {*} [options] Override http request option.
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public userControllerGetFollowingFollowersOfUser(options?: any) {
        return UserApiFp(this.configuration).userControllerGetFollowingFollowersOfUser(options)(this.fetch, this.basePath);
    }
