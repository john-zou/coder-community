...
export const CREATE_POSTS_IN_PROGRESS = "CREATE_POSTS_IN_PROGRESS";
export const CREATE_POSTS_DONE = "CREATE_POSTS_DONE";
export const CREATE_POSTS_IMG = "CREATE_POSTS_IMG";
export const CREATE_POSTS_TITLE = "CREATE_POSTS_TITLE";
export const CREATE_POSTS_CONTENT = "CREATE_POSTS_CONTENT";
export const CREATE_POSTS_TAGS = "CREATE_POSTS_TAGS";
...
export type ActionType =
  ...
  |typeof CREATE_POSTS_IN_PROGRESS
  | typeof CREATE_POSTS_DONE
  | typeof CREATE_POSTS_IMG
  | typeof CREATE_POSTS_TITLE
  | typeof CREATE_POSTS_CONTENT
  | typeof CREATE_POSTS_TAGS
  | typeof USER_PENDING
  | typeof USER_SUCCESS
  | typeof USER_FAILURE
